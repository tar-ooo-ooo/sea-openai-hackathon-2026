...
export default function Home() {
  return <div className="landing">
    ...
    <main className="landing-main"><section className="hero">
      <div><Image className="hero-illustration" src="/images/home-care-hero.jpg" alt="照顧者陪伴長輩的插畫" width={1672} height={941} priority /><p className="eyebrow">給正在照顧家人的你</p><h1>照顧有疑問，<br />我們陪你理清。</h1><p className="lead">不知道從哪裡開始申請長照？<br />先說說家人的日常困難，一起找到下一步。</p><Link className="button primary" href="/login">開始尋求照顧協助 <span aria-hidden="true">→</span></Link><p className="small muted">登入後開始整理，方便下次繼續。</p></div>
