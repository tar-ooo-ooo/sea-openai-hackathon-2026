...
test("詳情依種類驗證且拒絕錯誤／空資料", () => {
  const item = { id: _id, targetName: "測試", summary: "需求", createdAt: _date, updatedAt: _date, services: [] };
...
test("案件回應保留草稿缺漏、服務狀態與真正空集合", () => {
  ...
  const input = {
    ...
    cases: [{ id: _id, targetName: "測試對象", summary: "測試需求", createdAt: _date, updatedAt: _date,
